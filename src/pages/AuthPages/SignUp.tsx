...
export default function SignUp() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setLoading(true);
    try {
      // Create admin user directly (no OTP verification needed for admin signup)
      ...
      setError(err.response?.data?.message || err.message || 'Failed to create admin account. Please try again.');
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <>
      <PageMeta
        title="Admin Sign Up | ZEGN Dashboard"
        description="Create an administrator account for ZEGN Dashboard"
      />
